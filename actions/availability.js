...
function generateAvailableTimeSlots(
    ...
    while (currentTime < slotEndTime) {
        ...
        const isSlotAvailable = !booking.some((booking) => {
            const bookingtart = booking.startTime;
            const bookingEnd = booking.endTime;
            return (
                (currentTime >= bookingtart && currentTime < bookingEnd) ||
                (slotEnd > bookingtart && slotEnd <= bookingEnd) ||
                (currentTime <= bookingtart && slotEnd >= bookingEnd)
            );
        });
